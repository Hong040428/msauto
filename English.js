...
<head>
    ...
    <title>Microsoft Office 365 Sign Up</title>
    ...
    <style>
        .intro {
            background: url('https://www.microsoft.com/en-us/microsoft-365/blog/wp-content/uploads/2014/07/O365-Developer-Patterns-Practices.png') no-repeat;
...
<body>
    <div id="fullpage">
         <div class="section intro">
             <div class="mdui-appbar mdui-appbar-fixed mdui-color-white">
                 <div class="mdui-toolbar" style="width: 85%; margin: auto">
                    ...
                    <span class="mdui-typo-title screen">Office 365</span>
         ...
         <div class="mdui-text-color-orange" align="center" style="width: 70%;margin: auto">
                <img src="https://i.loli.net/2020/01/25/LF2q4bBN3rCMcDt.png" style="width: 250px">
                <h1 style="font-size: 28px;font-family:Monospace;font-weight: 600">Microsoft Office 365 Account Sign Up</h1>
                <h1 style="font-size: 30px;font-family:Monospace;font-weight: 500">This Account Subscription is E3</h1>
                <h1 style="font-size: 28px;font-family:Monospace;font-weight: 500">(5TB Onedrive + Desktop Office 365)</h1>
                <h1 style="font-size: 30px;font-family:Monospace;font-weight: 500">5TB Onedrive can Upgrade To 25TB After Used Up To 4.5TB</h1>
                <br><br><br><br>
                <a href="#form"><button class="mdui-btn mdui-ripple mdui-color-red mdui-m-a-2" style="width: 140px;height: 50px">Sign Up</button></a>
                <a href="https://www.office.com/login"><button class="mdui-m-a-2 mdui-btn mdui-ripple mdui-color-white" style="width: 140px;height: 50px">Login</button></a>
            </div>
         </div>
         <div class="section form">
            ...
            <div class="mdui-container">
                <div class="mdui-row">
                     <h2 style="font-size: 35px;font-family:Monospace;font-weight: 500" id="aform">Microsoft Office 365 Account Create Form</h2>
                     <form id="aform">
                         <div class="mdui-textfield mdui-textfield-floating-label">
                             <label class="mdui-textfield-label">Lastname *</label>
                             <input class="mdui-textfield-input" type="text" name="lastname" pattern="[A-z0-9]{1,10}" required>
                             <div class="mdui-textfield-error">Alphabet Only</div>
                         </div>
                         <div class="mdui-textfield mdui-textfield-floating-label">
                             <label class="mdui-textfield-label">Firstname *</label>
                         ...
                         <div class="mdui-textfield mdui-textfield-floating-label">
                             ...
                             <div class="mdui-textfield-error">@ Alphabet&Numbers Only</div>
                         </div>
                         <input type="submit" class="mdui-btn mdui-ripple mdui-color-yellow" value="Submit">
                         <div style="margin-top: 20px; font-family:Monospace; color: gray">* The account information will be displayed on the webpage after submission, PLEASE DO NOT REFRESH</div>
                     </form>
                     <div class="ainfo" style="display: none">
                        <h2 style="font-size: 30px;font-weight: 500">Account Create Success</h2>
                        <label class="mdui-textfield-label">Username</label>
                        <input class="mdui-textfield-input cremail" type="text" value="">
                        <label class="mdui-textfield-label">First Time Password</label>
                        <input class="mdui-textfield-input crpass" type="text" value="">
                        <a href="https://www.office.com/login" target="_blank"><button class="mdui-m-t-4 mdui-btn mdui-ripple mdui-color-red" style="width: 140px;height: 50px">Go To Login</button></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $('form').submit(function(e) {
            ...
            mdui.dialog({
                ...
                content: 'Click Submit to start creating an account, please be patient and don’t refresh the page',
                buttons: [{
                    text: 'Cancel'
                }, {
                    text: 'Submit',
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                if (response.stat == 'success') {
                                    ...
                                    mdui.alert('Creation failed, the username is ​​already occupied');
                                } else {
